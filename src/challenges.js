...
function filterOut(original1,toRemove1) {
if(original1.length === 0){return null}
  const newArr = []
  for (let i = 0; i < original1.length; i++ ){
   
    if(!toRemove1.includes(original1[i])){
      newArr.push(original1[i])
    }
